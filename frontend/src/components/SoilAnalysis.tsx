...
export function SoilAnalysis({ onNavigate, onLogout, role }: SoilAnalysisProps) {
  const soilMetrics = [
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <Navigation currentScreen="soil" onNavigate={onNavigate} onLogout={onLogout} role={role} />
